    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background, paddingTop: insets.top + 60, paddingBottom: insets.bottom + 24 }]}>
      <View style={styles.top}>
        <View style={[styles.logo, { backgroundColor: theme.colors.accentSoft }]}>
          <Ionicons name="medical" size={28} color={theme.colors.accent} />
        </View>
...
const styles = StyleSheet.create({
  ...
  top: { flex: 1 },
  logo: { width: 56, height: 56, borderRadius: 28, alignItems: "center", justifyContent: "center", marginBottom: 24 },
